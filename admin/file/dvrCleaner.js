...
usersRef.orderByChild("divisionType").equalTo("Cleanning").on("child_added", snap => {
...
for(var key in v)
{
	...
	"<h3 style='color:red;text-align:center;'>"+"Host Info"+"</h3>"+
	 ...
	 " <h6 style='margin-left:5%;' class='card-subtitle mb-2 text-muted'>"+"Date & Time: &nbsp" +v[key].timestamp+"</h6>"+
